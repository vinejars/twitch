...
const seed = async () => {
  ...
  const postFour = await Post.create({
    ...
    text: "I saw a turtle!!!",
    imageUrl:
      "https://scontent-lga3-1.xx.fbcdn.net/v/t1.6435-9/33676443_1404857716327256_4632945397872984064_n.jpg?_nc_cat=104&ccb=1-3&_nc_sid=0debeb&_nc_ohc=B3-GpN1Nq5IAX-3pTRV&_nc_ht=scontent-lga3-1.xx&oh=1b346423581b95c78cc5c7b4ebe7e39e&oe=61281A48",
  ...
  const postSix = await Post.create({
    ...
    text: `Just chillin`,
    imageUrl:
      "https://scontent-lga3-1.xx.fbcdn.net/v/t1.6435-9/33647288_10212022199775800_167076942233731072_n.jpg?_nc_cat=100&ccb=1-3&_nc_sid=0debeb&_nc_ohc=3-KcFQiGNawAX9tUleH&_nc_ht=scontent-lga3-1.xx&oh=38a2b39f1465aa53f541bee45b84e01e&oe=6127AE35",
    userId: "DOYAeIw0J0eSo8CsjS9rXENa0702",
  });
  ...
  const postSeven = await Post.create({
    ...
    text: null,
    imageUrl:
      "https://scontent-lga3-1.xx.fbcdn.net/v/t1.6435-9/33686550_1404857242993970_7993611862220472320_n.jpg?_nc_cat=111&ccb=1-3&_nc_sid=0debeb&_nc_ohc=rBwRDCMJ1CkAX_QxYPK&_nc_ht=scontent-lga3-1.xx&oh=ccd9483a5d88071f34b747bbc97af8e3&oe=612563F3",
  ...
  const postEight = await Post.create({
    ...
    text: null,
    imageUrl:
      "https://scontent-lga3-1.xx.fbcdn.net/v/t1.6435-9/33566795_1404857269660634_8480795766451863552_n.jpg?_nc_cat=105&ccb=1-3&_nc_sid=0debeb&_nc_ohc=RNDRUBJsm6QAX-WRSKe&_nc_ht=scontent-lga3-1.xx&oh=a0873c9c45a36c2a9be17fc300e648c1&oe=6127AF82",
    userId: "DU2qN1LKJ9buHAToMdCrT7lHUTq2",
  });
  ...
  const postNine = await Post.create({
    ...
    text: null,
    imageUrl:
      "https://scontent-lga3-1.xx.fbcdn.net/v/t1.6435-9/36923448_1449876108492083_6820135494538493952_n.jpg?_nc_cat=106&ccb=1-3&_nc_sid=cdbe9c&_nc_ohc=UKAZspVkwxMAX-0SCC4&_nc_ht=scontent-lga3-1.xx&oh=cb4e4ddf0941e6a0b6ec38b83fac75a5&oe=6127F101",
    userId: "DU2qN1LKJ9buHAToMdCrT7lHUTq2",
  });
  ...
  const quinnProfile = await ProfileInfo.create({
    ...
    destination:
      "I WANT TO VISIT EVERY ZOO IN THE WORLD BUT ALSO AVOID THE SPIDERS",
    userId: "DU2qN1LKJ9buHAToMdCrT7lHUTq2",
  });
